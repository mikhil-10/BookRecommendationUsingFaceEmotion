...
# #         break
# #
# # # Close webcam and destroy windows
# # webcam.release()
...
# #     st.write("Detected Emotions:", captured_emotions)
# #
# #     # Get book recommendation based on the first detected emotion
# #     book_recommendation = get_book_recommendations(captured_emotions[0])
# #
...
# #     music_recommendation = get_music_recommendations(captured_emotions[0])
# #
# #     # Display music recommendation
# #     st.header("Music Recommendation:")
# #     for music in music_recommendation:
# #         st.write(music)
# # else:
...
# #             for book in set(book_recommendation):  # Remove duplicates
# #                 st.write(book)
# #         else:
...
# #             for music in set(music_recommendation):  # Remove duplicates
# #                 st.write(music)
# #         else:
