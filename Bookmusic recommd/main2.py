...
#
#
# # Function to get book recommendations based on emotion and book type
# def get_book_recommendations(book_type, emotion):
#     filtered_df = kaggle_books_df[kaggle_books_df['Book Type'] == book_type]
#     emotion_df = filtered_df[filtered_df['Emotion'] == emotion]
#     return emotion_df['title'].tolist()
#
#
# # Function to get music recommendation based on emotion
...
# selected_emotion = st.selectbox("Select Emotion:", filtered_emotions)
#
# # Get recommended books based on the selected emotion and book type
# recommended_books = get_book_recommendations(book_type, selected_emotion)
#
# # Provide recommended books based on the selected emotion
# st.header("Recommended Books:")
#
